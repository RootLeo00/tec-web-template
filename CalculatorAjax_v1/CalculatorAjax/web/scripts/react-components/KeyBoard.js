...
class KeyBoard extends React.Component {
    ...
    render() {
        return (
            ...
            <button name="ln" onClick={this.props.onClick}>ln</button>
            <button name="sqrt" onClick={this.props.onClick}>sqrt</button>
            <button name="exp" onClick={this.props.onClick}>exp</button>
            <button name="1/x" onClick={this.props.onClick}>1/x</button><br/>
