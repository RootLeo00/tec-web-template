...
//NB: la consegna dice che l'argomento dei tasti "scientifici" è l'espressione mostrata nel display al momento della invocazione
    scientificCalculator(op) {
            try {
                ...
                requestCalculate(//chiama il js del calcolo passando l'uri della servlet e il dato
                    "./calculateServlet?data="+encodeURIComponent(JSON.stringify(request)),//chiama la servlet (./ parte dalla cartella attuale in cui si trova)
                (res) => {  
